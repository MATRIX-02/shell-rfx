...
const SupplierInformation = ({
	...
	const { supplierData, loading, error, createSupplier, fetchSupplierData } =
				...
				setPreviousPurchases(
					supplierData.approved_suppliers.map((purchase) => {
						...
						return {
							...
							sustainabilityScore: parseScore(purchase.sustainability_score),
	...
	return (
		<Container maxWidth="2xl" sx={{ mt: 0 }}>
			...
			>
				...
				<Box>
					<Tooltip title="Assign Supplier" placement="top">
						<IconButton
